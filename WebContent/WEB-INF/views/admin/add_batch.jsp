				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<fieldset>
							<div class="form-group">
							<p>Tên sản phẩm</p>
								<input class="form-control" placeholder="Samsung galaxy Y" id = "batchName" name="batchName" type="text" autofocus="" value = "${batchName }">
							</div>
							...
							<div class="form-group">
							<p>Giá sản phẩm</p>
								<input class="form-control" placeholder="10.000.000 VND" id = "price" name="price" type="number" autofocus="">
							</div>
